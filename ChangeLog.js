/**
 * This file is from https://github.com/powerfart-plugins/image-tools/blob/main/modules/ChangeLog.js
 */
...
const ChangelogStandardTemplate = getModuleByDisplayName(
    'ChangelogStandardTemplate',
    false
);
        ...
        if (this.needChangeLog) {
            openModal(() =>
                React.createElement(Changelog, {
                    ...
                    onClose: () =>
                        this.args.updateLastCheckedVer(this.args.currentVer),
                    onScroll: () => null
                })
            );
        }
        ...
        const parseContent = (content, depp = 0) => {
            if (Array.isArray(content)) {
                ...
                return content
                    .map(
                        e =>
                            `${Array.isArray(e) ? '' : prefix}${parseContent(
                                e,
                                depp + 1
                            )}`
                    )
