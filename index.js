...
const { userTypes, DEFAULT_TAG_TEXTS } = require('./constants');
...
module.exports = class StaffTags extends Plugin {
    constructor() {
        ...
        this.ChangeLog = new ChangeLog({
            ...
            updateLastCheckedVer: v =>
                this.settings.set('lastChangeLogVersion', v)
        });
    }
    ...
    async injectMembers() {
        ...
        inject(
            'ownertag-members-1',
            MemberListItemTarget.module,
            MemberListItemTarget.method,
            function (_, res) {
                    ...
                    function (_, res) {
                        ...
                        if (guild) {
                            ...
                            data = {
                                userType: userTypes.GOWNER,
                                color:
                                    useCustomColor && tagColor ? tagColor : null
                            };
                        }
                        ...
                        if (data && data.userType !== userTypes.NONE) {
                            if (_this.settings.get('showCrowns', false)) {
                                ...
                                res.props.children[size] =
                                    res.props.children[size - 1];
